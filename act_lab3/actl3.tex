...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \captionsetup{skip=0pt}
        \caption{График $u(t)$ для $\alpha_1=2$ при $K_{2\,\alpha1},\ \mu_1=8.0090$}
    ...
    \begin{figure}[H]
        ...
        \captionsetup{skip=0pt}
        \caption{График $u(t)$ для $\alpha_2=0.1$ при $K_{2\,\alpha2},\ \mu_2=4.2015$}
    ...
    При $Q=I$
    $$
    K_{3\,\alpha1}=\begin{bmatrix}
        2.1164  &-13.4942    &1.6777
    \end{bmatrix}
    $$
    $$
    K_{3\,\alpha2}=\begin{bmatrix}
        -0.8455   &-3.3716   &-0.5697
    \end{bmatrix}
    $$
    $$
    \sigma\left( A+BK_{3\,\alpha1} \right)=\left\{ -2, -2.4114\pm4.3116i \right\}
    $$
    $$
    \sigma\left( A+BK_{3\,\alpha2} \right)=\left\{ -2, -0.6692\pm2.3797i \right\}
    $$


    При $Q=0$
    $$
    K_{4\,\alpha1}=\begin{bmatrix}
        1.6000  &-11.2000    &1.6000
    \end{bmatrix}
    $$
    $$
    K_{4\,\alpha2}=\begin{bmatrix}
        -0.7560   &-2.6880   &-0.7560
    \end{bmatrix}
    $$
    $$
    \sigma\left( A+BK_{4\,\alpha1} \right)=\left\{ -2, -2.0000\pm4.1231i \right\}
    $$
    $$
    \sigma\left( A+BK_{4\,\alpha2} \right)=\left\{ -2, -0.1000\pm2.3259i \right\}
    $$
